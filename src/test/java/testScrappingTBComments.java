...
public class testScrappingTBComments {
    ...
    private static String referPage = "https://item.taobao.com/item.htm?id=581723516301";
    ...
    public static void main(String[] args) throws Exception{
        String url = "https://rate.taobao.com/feedRateList.htm?auctionNumId=581723516301&userNumId=379822779&currentPageNum=2&pageSize=20&rateType=&orderType=sort_weight&attribute=&sku=&hasSku=false&folded=0&_ksTS=1557299851523_4113&callback=jsonp_tbcrate_reviews_list";
        URL obj = new URL(url);
